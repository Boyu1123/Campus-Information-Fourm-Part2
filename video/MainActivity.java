...
public class MainActivity extends Activity {
	...
	String filePath="http://115.28.105.184/vipboard.mp4";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
        ...
        filePath=getIntent().getStringExtra("path")==null?"http://115.28.105.184/vipboard.mp4":getIntent().getStringExtra("path");
