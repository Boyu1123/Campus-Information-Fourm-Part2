...
public class NewChatActivity extends Activity implements OnClickListener {
	...
	public static String ACTION_MSG = "com.msg";
	...
	private MsgAcceptBroadcast broadcast = new MsgAcceptBroadcast();
	private E_User userInfo;
	private String author;
	private E_Friend friend;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		registerReceiver(broadcast, new IntentFilter(ACTION_MSG));
		
		MyApplication app = (MyApplication) getApplication();
		userInfo = app.getUser();
		
		friend = (E_Friend) getIntent().getSerializableExtra("friend");
		author = friend.getFriendname();
	...
	public void initView() {
		...
		chat_to = (TextView) findViewById(R.id.chat_to);
		chat_to.setText(author);
		...
		mEditTextContent = (EditText) findViewById(R.id.chat_mess);
	...
	public void initData() {
		for (int i = 0; i < COUNT; i++) {
			...
			if (i % 2 == 0) {
				...
				entity.setHead(friend.getFriendhead());
				entity.setMsgType(true);
			} else {
				entity.setName(userInfo.getName());
				entity.setHead(userInfo.getPhotourl());
	...
	private void send() {
		...
		if (contString.length() > 0) {
			...
			params.put("message", contString);
			params.put("deviceId", String.valueOf(friend.getFriendid()));
			HttpServer.sendMsg(params, null, URLConstants.BASEURL
					+ URLConstants.CHATURL, new Callback() {
